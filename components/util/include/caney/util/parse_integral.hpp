...
namespace caney {
	namespace util {
		inline namespace v1 {
			/* parse_integral_open<Integral>(str): parse number from minimal decimal string representation
			...
			/* parse_integral<Integral>(str): parse number from minimal decimal string representation
			 * - optional '-' prefix for negative values if `Integral` is signed type
			 * - no leading zeroes permitted
			 * - no leading '+' permitted
